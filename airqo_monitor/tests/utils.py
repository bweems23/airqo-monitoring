...
def create_malfunction_global_vars():
    # airqo vars
    GlobalVariable.objects.create(key='AIRQO_LOW_BATTERY_CUTOFF', value=3.3)
    GlobalVariable.objects.create(key='AIRQO_NUM_REPORTS_TO_VERIFY_SENSOR_MALFUNCTION', value=10)
    GlobalVariable.objects.create(key='AIRQO_SENSOR_PM_2_5_MIN_CUTOFF', value=1.0)
    GlobalVariable.objects.create(key='AIRQO_SENSOR_PM_2_5_MAX_CUTOFF', value=1000.0)
